...
window.Modules.dashboard = (() => {
  ...
  // >>> Grupos/visões para Engajamento por Hora
  const HOURLY_GROUPS = [
    {
      key: 'monThu',
  ...
  function init() {
    ...
    // seletor de visão do gráfico horário (se existir no HTML)
  ...
  function renderOverview() {
    ...
    ringStatuses.forEach(statusCode => {
      ...
      // Inserir as médias de pareceres logo após ANATEC-PRE
  ...
  function renderYearlyActivity() {
    ...
    // Contar cada processo apenas uma vez por status no ano
    ...
    // Notificações: pela data efetiva do pedido
    ...
    // SIGADAER EXPEDIDO: pela data de expedição
  ...
  // --- Suporte a múltiplas visões do gráfico horário
